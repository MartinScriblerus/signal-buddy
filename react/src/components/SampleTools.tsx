...
const SampleTools = (props: SampleToolsProps) => {
    const { bpm, sampleLength, sampleRates, samplePositionStart, handleChangeBPM, handleChangeSampleStartPosition, handleChangeSampleLength, handleChangeSampleRates } = props;
    return (
        <Box 
