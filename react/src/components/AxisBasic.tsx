...
export const AxisBasic = ({ width=1000, height=1000 }: AxisBasicProps) => {
    ...
    <div>
      <svg width={width} height={height} shapeRendering={"crispEdges"}>
        ...
        >
          ...
          {/* Y axis */}
          <AxisLeft width={1000} yScale={yScale} pixelsPerTick={30} />

          {/* X axis, use an additional translation to appear at the bottom */}
          <g transform={`translate(0, ${boundsHeight})`}>
            <AxisBottom height={1000} xScale={xScale} pixelsPerTick={60} />
          </g>
        </g>
      </svg>
    </div>
